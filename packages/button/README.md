...
| `$border-color-active`          | `core.$color`                                  | Sets the border-color property on `:active` state.                                                                                                |
...
| `$background-active`            | `transparent`                                  | Sets the background-color property on `:active` state.                                                                                            |
| `$box-shadow`                   | `none`                                         | Sets the box-shadow property.                                                                                                                     |
...
| `$outline`                      | `rgba(core.$black, 0) solid 0`                 | Sets the outline property.                                                                                                                        |
...
| `$outline-offset-focus-visible` | `null`                                         | Sets the outline-offset property on `:focus-visible` state.                                                                                       |
