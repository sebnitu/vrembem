...
test('check a list of classes to see if some exist in a NodeList', () => {
  ...
  let cjsResult = u.hasClass(p, 'c', 'd', 'e');
  expect(result).toBe(true);
  expect(cjsResult).toBe(true);
});
