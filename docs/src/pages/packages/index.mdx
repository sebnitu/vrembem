...
The core module (`@vrembem/core`) is used by all packages and is the central place that shared configurations live. To make Vrembem wide changes (such as adjusting prefix values or color palettes), the core module is the place to do that.
...
<div class="flex">
  ...
  <span class="test-1 vb-theme-auto">vb-theme-auto</span>
...
<div class="flex">
  ...
  <span class="test-2 vb-theme-auto">vb-theme-auto</span>
...
<div class="flex">
  ...
  <span class="test-3 vb-theme-auto">vb-theme-auto</span>
...
- `vb-theme-auto`: Will display the theme of the users preference.
