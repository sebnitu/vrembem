...
Output all the stored custom properties of a provided module or of all modules. Provided module must exist in the custom properties map.
...
Mixin to override a previously defined custom property. This is primarily used in the context of a modifier. Provided module must exist in the custom properties map.
...
Log to console either all set custom properties, a module map or module theme. Provided module must exist in the stored custom properties map.
