...
Applies a color theme to the notice, useful for conveying different states such as success, info, or error. These modifiers are generated using key/value pairs of the `notice-color` config options map.
