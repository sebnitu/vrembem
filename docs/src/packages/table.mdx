...
@include css.set("table", (
  ...
  "border": $border,
  "border-alt": $border-alt,
  "mobile-label": (
    "width": $mobile-label-width,
    "spacing": $mobile-label-spacing,
    "background": $mobile-label-background,
    "foreground": $mobile-label-foreground,
  )
));
