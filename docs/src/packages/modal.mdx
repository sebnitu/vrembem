...
Stores currently open modals in the order they were opened and manages their visual stacking order. When the stack order changes, the `stackChange` event is emitted.
