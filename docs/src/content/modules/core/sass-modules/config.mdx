---
title: core/config
description: "A Sass module for managing global configuration options. This is available across all components to set things like BEM naming syntax, prefixes, and output options."
order: 1
---
...
@include config.set("prefix-themes", "theme");

// 3. Get a configuration value
@debug config.get("prefix-themes"); // => "theme"
```
</CodeExample>
