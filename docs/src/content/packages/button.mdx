...
<FileReference name="CSS Vars" file="button/src/_root.scss">
...
<FileReference name="SCSS Vars" file="button/src/_variables.scss">
...
<DocBlock name="button-variant" type="mixin" src="#">
