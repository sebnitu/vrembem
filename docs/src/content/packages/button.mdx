...
<FileReference name="CSS Variables" file="button/src/_button.scss">

  ```scss
  // Notice: Prefix variable in CSS var names have
  // been replaced with its default value of "vb-".
...
<FileReference name="SCSS Variables" file="button/src/_variables.scss">
