...
Sets an elements width and flex-basis to `auto` with an optional breakpoint condition.
...
Sets an elements width and flex-basis to `auto` and flex-grow to `1` with an optional breakpoint condition.

<CodeExample>
  <Fragment slot="output">
    <div class="grid">
      <div class="grid__item span-grow"><div class="box">...</div></div>
      <div class="grid__item"><div class="box">...</div></div>
      <div class="grid__item"><div class="box">...</div></div>
    </div>
  </Fragment>
  ```html
  <div class="grid">
    <div class="grid__item span-grow">...</div>
    <div class="grid__item">...</div>
    <div class="grid__item">...</div>
  </div>
  ```
...
Sets an elements flex property to `none` and width to `100%` with an optional breakpoint condition.
