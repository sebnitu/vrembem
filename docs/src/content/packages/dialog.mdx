    ...
    <div class="gap-y-xl">
      <div class="dialog">
        <div class="dialog__header">
          <h2 class="dialog__title">No theme</h2>
      ...
      <div class="dialog vb-theme-root">
        <div class="dialog__header">
          <h2 class="dialog__title">Root theme</h2>
          <button class="button button_icon button_size_sm">
            <Icon name="x" iconClass="icon_size_sm" />
          </button>
        </div>
      ...
      <div class="dialog vb-theme-light">
        <div class="dialog__header">
          <h2 class="dialog__title">Light theme</h2>
          <button class="button button_icon button_size_sm">
            <Icon name="x" iconClass="icon_size_sm" />
          </button>
        </div>
      ...
      <div class="dialog vb-theme-dark">
        <div class="dialog__header">
          <h2 class="dialog__title">Dark theme</h2>
          <button class="button button_icon button_size_sm">
            <Icon name="x" iconClass="icon_size_sm" />
          </button>
        </div>
