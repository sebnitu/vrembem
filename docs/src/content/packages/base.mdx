...
The font-size of heading elements are controlled by the `$heading-scale` Sass variable map. The map should contain a key of the heading level and the value of a font-size and optional line-height space separated.
