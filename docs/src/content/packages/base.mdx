...
<ReferenceTable id="cssvar-base" data={{
  "--vb-base-height": "100%",
  "--vb-base-background": "var(--vb-background)",
  "--vb-base-foreground": "var(--vb-foreground)"
}} valueLabel="Fallback" />

### blockquote

<ReferenceBar selector=".blockquote" />
...
The following CSS variables are referenced with a provided fallback for more easily overriding blockquote properties:

<ReferenceCard name="--vb-blockquote-background" type="color" fallback="transparent">
  Used to set the background property of the `.blockquote` class.
</ReferenceCard>

<ReferenceCard name="--vb-blockquote-foreground" type="color" fallback="currentcolor">
  Used to set the color property of the `.blockquote` class.
</ReferenceCard>

<ReferenceCard name="--vb-blockquote-border" type="width | style | color" fallback="var(--vb-border)">
  Used to set the border property of the `.blockquote` class.
</ReferenceCard>

<ReferenceCard name="--vb-blockquote-border-radius" type="number value" fallback="var(--vb-border-radius)">
  Used to set the border-radius property of the `.blockquote` class.
</ReferenceCard>

<ReferenceCard name="--vb-blockquote-padding" type="number value" fallback="1em">
  Used to set the padding property of the `.blockquote` class.
</ReferenceCard>

<ReferenceCard name="--vb-blockquote-gap" type="number value" fallback="1em">
  Used to set the margin-top property of children (except the first-child) in the `.blockquote` class element.
</ReferenceCard>
