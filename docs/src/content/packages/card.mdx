...
Card screens and backgrounds are displayed behind the other card elements. These can be paired with the `vb-theme-dark` class which switches text colors to better suite a dark background theme.
