...
Below is a reference to all CSS variables that are referenced by the `drawer` component along with their fallback values. These variables are only referenced and not defined, allowing you to easily customize styles by setting your own values as needed.

<ReferenceTable id="cssvar-drawer" valueLabel="Fallback" data={{
