...
<DocBlock name="drawer.collection" type="property" returns="array" src="core/src/js/Collection.js" line="3">
  ...
  ```scss
  {
    ...
    config: Object // The drawer specific configuration object.
    ...
    getConfig: Function // Method that returns either a drawer specific setting or global drawer setting.
  }
  ```
</DocBlock>
