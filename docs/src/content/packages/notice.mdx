...
For cases where a notice message should be displayed alongside an icon or image, try combining it with the [flex](/packages/flex) utility component.
  ...
  <div slot="output" class="spacing">
    <div class="notice notice_color_important">
      <div class="flex flex-nowrap">
        ...
        <div class="flex-auto">
          This is an example notice using the flex utility component for layout.
        </div>
      </div>
    </div>
