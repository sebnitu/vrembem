...
<CodeExample>
  <Fragment slot="output">
    <div class="flex gap">
      <button class="button foreground-primary">Button 1</button>
      <button class="button foreground-secondary">Button 2</button>
      <button class="button foreground-neutral">Button 3</button>
      <button class="button foreground-important">Button 4</button>
    </div>
  </Fragment>
```html
