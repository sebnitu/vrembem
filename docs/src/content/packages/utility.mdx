...
Utilities for setting the border-radius property with optional corner variants of an element. The value and variants used by the border-radius utility is built from the `utility-border-radius` configuration option.
