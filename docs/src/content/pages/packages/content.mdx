...
Content comes with the following Sass configuration options that can be set using either the [config module](/modules/config#using-config-module) or [Sass `with` clause](/modules/config#using-with-clause) methods.
