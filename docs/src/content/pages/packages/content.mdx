---
title: Content
description: "Provides typographic styles for commonly used HTML elements."
...
import data from "@/content/data/tokens-content.json";
...
<ReferenceCard name="content-output" type="boolean" defaults="true">
...
<ReferenceCard name="content-output-exceptions" type="list" defaults="()">
...
<ReferenceCard name="content-classes" type="map" defaults="()">
...
<ReferenceCard name="content-prefix" type="map" defaults='""'>
...
<ReferenceCard name="content-selectors" type="map">
...
<ReferenceCard name="content-headings" type="map">
...
<CodeExample lang="html">
<div slot="output" class="flex flex--items-auto">
  <ul class="list">
    <li>One</li>
    <li>
      Two
...
<ReferenceBar selector=".divider" hash={{
  target: "reference-table-tokens-content",
  event: "filter",
  detail: {
    value: "--vb-divider"
...
This module adds the `.divider` CSS class which visually renders a horizontal divider. This is most commonly applied to an `<hr>` HTML element but can also be applied to a more generic `<span>` or `<div>` depending on the semantic context.
