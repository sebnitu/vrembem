---
title: Table
description: "Provides style variants for displaying tabular data."
...
<CodeExample>
  <Fragment slot="output">
    <table class="table table--mobile table--style-bordered">
      <thead>
        <tr>
          <th>Name</th>
          <th>Mass</th>
...
This modifier come with media breakpoint variants. This allows changing styles based on a specific breakpoint key in the [`breakpoints`](/packages/core#options) config options map. Breakpoint variants output can be toggled using the `breakpoints` key in the `table-mobile` config options map (default: `true`).
...
<CodeExample>
  <div slot="output" class="spacing">
    <table class="table table--padding-sm table--style-bordered">
      <thead>
        <tr>
          <th>Name</th>
          <th>Mass</th>
    ...
    <table class="table table--padding-lg table--style-bordered">
      <thead>
        <tr>
          <th>Name</th>
          <th>Mass</th>
...
These modifiers come with media breakpoint variants. This allows changing styles based on a specific breakpoint key in the [`breakpoints`](/packages/core#options) config options map. Breakpoint variants output can be toggled using the `breakpoints` key in the `table-padding` config options map (default: `true`).

<CodeExample>
  <div slot="output" class="spacing">
    <p>Current view-port width: <code data-vp-width>...</code></p>
    <table class="table table--padding-sm lg:table--padding-md xl:table--padding-lg table--style-bordered">
      <thead>
        <tr>
          <th>Name</th>
          <th>Mass</th>
