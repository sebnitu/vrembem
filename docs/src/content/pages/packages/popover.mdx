...
{/* TODO: Update documentation for new popovers */}
...
When using the [`cssConfig`](/reference/collections/plugins/css-config) plugin, the following CSS variables can be used to set JavaScript configuration options.
