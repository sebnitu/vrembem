...
The examples in this section assume you are using the default configuration provided by Vrembem such as `prefix-tokens`, `breakpoints`, and `palette`. For more information on config options, see the [`core/config`](/modules/config) documentation.
