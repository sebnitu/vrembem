...
<div class="scroll-box">
  <table class="table table_style_bordered table_zebra table_hover table_responsive_lg">
    ...
    <tbody>
      <tr>
        <td data-mobile-label="Var"><code class="code text-nowrap">$state ("default")</code></td>
        <td data-mobile-label="Type"><code class="code color-secondary text-nowrap">string</code></td>
        <td data-mobile-label="Desc">The state that should be output. Can either be <code class="code">"hover"</code>, <code class="code">"focus"</code> or omitted for default output.</td>
      </tr>
      <tr>
        <td data-mobile-label="Var"><code class="code text-nowrap">$color (null)</code></td>
        <td data-mobile-label="Type"><code class="code color-secondary text-nowrap">color</code></td>
        <td data-mobile-label="Desc">The base color to use in the box-shadow property value.</td>
      </tr>
    </tbody>
  </table>
</div>
