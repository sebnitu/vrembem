...
<div class="scroll-box">
  <table class="table table_style_bordered table_zebra table_hover table_responsive_lg">
    ...
    <tbody>
      <tr>
        <td data-mobile-label="Name">
          <code class="code text_nowrap">drawer.init()</code>
        </td>
      ...
      <tr>
        <td data-mobile-label="Name">
          <code class="code text_nowrap">drawer.destroy()</code>
        </td>
        <td data-mobile-label="Desc">
      ...
      <tr>
        <td data-mobile-label="Name">
          <code class="code text_nowrap">drawer.toggle(drawerKey, callback)</code>
        </td>
        <td data-mobile-label="Desc">
      ...
      <tr>
        <td data-mobile-label="Name">
          <code class="code text_nowrap">drawer.open(drawerKey, callback)</code>
        </td>
        <td data-mobile-label="Desc">
      ...
      <tr>
        <td data-mobile-label="Name">
          <code class="code text_nowrap">drawer.close(drawerKey, callback)</code>
        </td>
        <td data-mobile-label="Desc">
