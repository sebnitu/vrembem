...
## v4.0.0-next.52 (2026-08-18)

### :bug: Bug Fix
* `core`, `notice`, `vrembem`
  * [#2960](https://github.com/sebnitu/vrembem/pull/2960) Fix remaining package configurations and exports

### :books: Documentation
* [#2959](https://github.com/sebnitu/vrembem/pull/2959) Add documentation for JavaScript entries
...
### :bug: Bug Fix
* `drawer`, `modal`
  * [#2049](https://github.com/sebnitu/vrembem/pull/2049) Use custom property refs when applying screen variables
...
### :bug: Bug Fix
* `core`
  * [#2048](https://github.com/sebnitu/vrembem/pull/2048) Add missing space argument in get-hs function
...
### :tada: New Feature
* `popover`, `utility`
  * [#1991](https://github.com/sebnitu/vrembem/pull/1991) Add basic transition utilities
* `core`, `popover`, `vrembem`
  * [#1990](https://github.com/sebnitu/vrembem/pull/1990) Improve support for multiple popovers on a single trigger


## v4.0.0-next.23 (2024-08-04)

### :bug: Bug Fix
* `popover`
  * [#1969](https://github.com/sebnitu/vrembem/pull/1969) Apply inert attribute on popovers when they're closed


## v4.0.0-next.22 (2024-08-04)

### :bug: Bug Fix
* `popover`
  * [#1968](https://github.com/sebnitu/vrembem/pull/1968) Update popover check to avoid false positive with empty object
